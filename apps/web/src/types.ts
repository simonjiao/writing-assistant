...
export interface RunResponse { run: WorkflowRun; article?: ArticleArtifact; events: AgentEvent[]; humanGates?: HumanGate[]; operations?: WorkflowOperation[]; reviewArtifacts?: ReviewArtifact[]; revisionProposals?: RevisionProposal[] }
