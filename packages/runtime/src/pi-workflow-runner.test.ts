...
const testPolicy = {
  ...
  goal: '测试 workflow',
  allowedActionPolicy: '测试动作策略',
  humanGatePolicy: '测试人工确认策略',
  completionPolicy: '测试完成策略',
};
const singletonPlanner = {
  plan() {
    return [{ id: 'act_1', operationId: 'op_1', type: 'plan_outline', articleId: 'art_1', baseRevision: 3, requiresHumanGate: false, reason: '生成大纲。' }];
  },
};
