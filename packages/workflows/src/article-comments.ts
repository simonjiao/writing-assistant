...
import type { ArticleCommentResolverInput, ArticleCommentResolverOutput } from './article-comment-resolver';
import { agentOperationId } from './agent-operation-ids';
...
export async function processArticleComments(
  ...
  for (const comment of targets) {
    ...
    try {
      ...
      const output = await deps.agentToolExecutor.executeTool<ArticleCommentResolverInput, ArticleCommentResolverOutput>({
