import { DialogueBrief, DialogueBriefItemKind, safeJsonParse, Skill } from '@wa/core';
...
export class DialogueBriefUpdaterSkill implements Skill<DialogueBriefUpdaterInput, DialogueBriefUpdaterOutput> {
  manifest = {
  ...
  async invoke({ input, llm }: Parameters<Skill<DialogueBriefUpdaterInput, DialogueBriefUpdaterOutput>['invoke']>[0]): Promise<DialogueBriefUpdaterOutput> {
