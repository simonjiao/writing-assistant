...
export class OutlineReviserProgram implements PromptProgram<OutlineReviserInput, OutlineReviserOutput> {
  manifest = {
    id: 'outline-reviser',
  ...
  async invoke({ input, context, llm }: Parameters<PromptProgram<OutlineReviserInput, OutlineReviserOutput>['invoke']>[0]): Promise<OutlineReviserOutput> {
