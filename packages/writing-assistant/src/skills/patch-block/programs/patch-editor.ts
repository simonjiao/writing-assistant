...
export class PatchEditorProgram implements PromptProgram<PatchEditorInput, PatchEditorOutput> {
  manifest = {
    id: 'patch-editor',
    name: 'Patch Editor',
    version: '0.1.0',
  ...
  async invoke({ input, context, llm }: Parameters<PromptProgram<PatchEditorInput, PatchEditorOutput>['invoke']>[0]): Promise<PatchEditorOutput> {
