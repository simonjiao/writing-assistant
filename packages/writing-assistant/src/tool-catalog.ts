...
import { ToolRegistry, executePromptProgram, ProductToolDefinition, ProductSkillRegistry } from '@wa/runtime';
import { productToolSchemas } from './schemas/tool-schemas';
import { registerWritingAssistantProductSkills } from './product';
...
export function registerWritingAssistantTools(registry = new ToolRegistry(), productSkills = registerWritingAssistantProductSkills()): ToolRegistry {
